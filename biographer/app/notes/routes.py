...
@bp.route("/notes-home", methods=["GET", "POST"])
def home():
    db.create_all()
    ...
    return render_template("tools/notes/index.html", notebooks=all_notebooks, notebook_available=notebook_available)
...
def create_notebook():
    if request.method == "POST":
        if request.form["name"] and not request.form["name"].isspace():
            ...
            return render_template("tools/notes/create_notebook.html", message="Name cannot be blank")
    else:
        return render_template("tools/notes/create_notebook.html")


@bp.route("/notebooks/<int:notebook_id>/delete", methods=["GET", "POST"])
    ...
    if request.method == "POST":
        ...
        if Notebook.query.get(notebook_id).password is not None:
            if hashlib.sha256(request.form["password"].encode('utf-8')).hexdigest() == Notebook.query.get(
                ...
                return render_template("tools/notes/delete_notebook.html", name=Notebook.query.get(notebook_id).name,
        ...
        if Notebook.query.get(notebook_id).password is None:
            ...
            password = True
        return render_template("tools/notes/delete_notebook.html", name=Notebook.query.get(notebook_id).name, id=notebook_id,
                               password=password)


@bp.route("/notebooks/<int:notebook_id>/note/<int:note_id>/delete", methods=["GET", "POST"])
def delete_note(notebook_id, note_id):
    if request.method == "POST":
        ...
        return render_template("tools/notes/delete_note.html", notebook=Notebook.query.get(notebook_id).id,
                               note=Notes.query.get(note_id).id)


@bp.route("/notebooks/<int:notebook_id>", methods=["GET", "POST", "DELETE"])
def open_notebook(notebook_id):
    if Notebook.query.get(notebook_id).password is None:
        return render_template("tools/notes/open.html", notes=Notes.query.filter(Notes.notes_notebook == notebook_id),
...
@bp.route("/notebooks/<int:notebook_id>/login", methods=["GET", "POST"])
def login_notebook(notebook_id):
    if request.method == "POST":
        ...
        if password == Notebook.query.get(notebook_id).password:
            ...
            return render_template("tools/notes/notebook_login.html", notebook=Notebook.query.get(notebook_id),
...
@bp.route("/notebooks/<int:notebook_id>/note/create", methods=["GET", "POST"])
def create_note(notebook_id):
    if request.method == "POST":
        if request.form["name"] and not request.form["name"].isspace():
            ...
            return render_template("tools/notes/create_note.html", message="Name cannot be blank", id=notebook_id)
    else:
        return render_template("tools/notes/create_note.html", id=notebook_id)


@bp.route("/notebooks/<int:notebook_id>/note/<int:note_id>", methods=["GET", "POST"])
...
def edit_notebook(notebook_id):
    if request.method == "POST":
        if request.form["name"] and not request.form["name"].isspace():
            ...
            return render_template("tools/notes/edit_notebook.html", notebook=Notebook.query.get(notebook_id),
                                   message="Name cannot be Blank")

    return render_template("tools/notes/edit_notebook.html", notebook=Notebook.query.get(notebook_id))


@bp.route("/notebook/<int:notebook_id>/note/<int:note_id>/section/create", methods=["GET", "POST"])
def create_section(notebook_id, note_id):
    ...
    return render_template("tools/notes/create_section.html", notebook=notebook_id, note=note_id)


@bp.route("/notebook/<int:notebook_id>/note/<int:note_id>/section/<int:section_id>/delete", methods=["GET", "POST"])
def delete_section(notebook_id, note_id, section_id):
    ...
    return render_template("tools/notes/delete_section.html", notebook=notebook_id, note=note_id, section=Section.query.get(section_id))
